...
install.packages(c("tidyverse","geodata","MODISTools","phenocamr","terra","GenSA"))
```
...
https://github.com/bluegreen-labs/data/raw/
...
## Parameter optimization cost function
